...
function HomePageBodyComponent() {
    ...
    <section class="py-12 bg-black sm:pb-16 lg:pb-20 xl:pb-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="relative">
                <div class="lg:w-2/3">
                    <p class="text-sm font-normal tracking-widest text-gray-300 uppercase">Getting Better Music Recommendations</p>
                    <h1 class="mt-6 text-4xl font-normal text-white sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl"><span class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">Perfect Your</span> Playlists</h1>
                    ...
                    <div>
                        <div class="inline-flex items-center pt-6 mt-8 border-t border-gray-800 sm:pt-10 sm:mt-14">
                            <span class="ml-2 text-base font-normal text-white"> Over 10,000+ songs recommended to users or some other value</span>
                        </div>
                    </div>
                </div>
